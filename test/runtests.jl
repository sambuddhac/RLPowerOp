...
import Aqua
Aqua.test_unbound_args(RLPowerOp)
Aqua.test_undefined_exports(RLPowerOp)
Aqua.test_ambiguities(RLPowerOp)
Aqua.test_stale_deps(RLPowerOp)
Aqua.test_deps_compat(RLPowerOp)
